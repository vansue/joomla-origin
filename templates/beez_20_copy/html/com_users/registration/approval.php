...
<div class="registration<?php echo $this->pageclass_sfx?>">
	<h1>Override đăng ký người dùng</h1>
...
<?php endforeach;?>
		<div>
			<fieldset>
				<legend>Điều khoản dịch vụ</legend>
				<p><input type="checkbox" name="tos_agree" /> Tôi đồng ý với điều khoản dịch vụ của website.</p>
				<?php if($this->params->get('show_age_checkbox')) : ?>
					<p><input type="checkbox" name="old_enough" /> Tôi là người trên 18 tuổi.</p>
				<?php endif; ?>
			</fieldset>
